...
class TicTonAsyncClient:
    def __init__(
        ...
        wallet_version: Optional[Literal[
        ...
        *,
        ...
        assert mnemonics is not None, "mnemonics must be provided, you can either pass it as a parameter or set TICTON_WALLET_MNEMONICS environment variable"
        ...
        # TODO: get these parameters from oracle
        self.base_asset_decimals = 9
        self.quote_asset_decimals = 6
        self.min_base_asset_threshold = to_token(1, self.base_asset_decimals)
    ...
    async def _convert_price(self, price: float) -> FixedFloat:
        ...
        return FixedFloat(price) * 10 ** (self.quote_asset_decimals - self.base_asset_decimals)
